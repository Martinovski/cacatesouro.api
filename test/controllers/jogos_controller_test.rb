...
class JogosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create jogo" do
    assert_difference('Jogo.count') do
      post jogos_url, params: { jogo: { pessoa_id: @jogo.pessoa_id, pista_id: @jogo.pista_id } }
    end
  ...
  test "should update jogo" do
    patch jogo_url(@jogo), params: { jogo: { pessoa_id: @jogo.pessoa_id, pista_id: @jogo.pista_id } }
